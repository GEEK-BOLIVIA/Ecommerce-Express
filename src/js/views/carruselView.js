...
export const carruselController_View = {
    ...
    async render() {
        ...
        try {
            // ✅ Reemplazado: carruselController.cargarCarruseles() → carruselService.listar()
            let datos = await carruselService.listar();
    ...
    async verDetalles(id, nombre, tipo) {
        ...
        try {
            // ✅ Reemplazado: carruselController.cargarItemsPorCarrusel(id) → carruselService.obtenerItems(id)
            const itemsRaw = await carruselService.obtenerItems(id);

            // Mapeo igual al que hacía carruselController.cargarItemsPorCarrusel
